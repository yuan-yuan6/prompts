...
```markdown
I need to develop effective board reporting and governance communication strategies. Please provide a comprehensive board communication framework.
...
### Example 1: Public Company Board
```markdown
Company type: NYSE-listed corporation
Board size: 11 directors (9 independent)
Committees: Audit, Compensation, Nominating, Risk
Meeting frequency: 6 regular, 2-3 special annually
Key challenges: Activist investor, digital transformation
```

### Example 2: Private Equity Portfolio Company
```markdown
Ownership: PE firm 70%, Management 30%
Board composition: 5 PE, 2 independent, 2 management
Governance focus: Value creation, exit planning
Reporting needs: Monthly operating, quarterly strategic
Exit timeline: 3-5 year horizon
```

### Example 3: Non-Profit Board
```markdown
Organization: Healthcare foundation
Board size: 15-20 volunteer directors
Committees: Executive, Finance, Audit, Programs
...
- Adapt for different organization types and structures
- Scale for various board sizes and compositions
- Include industry-specific governance requirements
- Adjust for different regulatory frameworks
- Incorporate geographic and cultural considerations
- Add crisis and special situation protocols
- Customize for different stakeholder priorities
- Include technology and digital governance