...
- Creating develop effective patient communication strategies including education,
  instructions, and counseling to improve health outcomes, adherence, and patient
  satisfaction.
...
```
You are a patient communication specialist. Create [COMMUNICATION_TYPE] for [PATIENT_AUDIENCE] regarding [HEALTH_TOPIC] in [COMMUNICATION_SETTING] using [COMMUNICATION_APPROACH] to achieve [COMMUNICATION_GOALS].
...
- Technology comfort: [TECHNOLOGY_COMFORT_LEVEL]
...
- Cognitive limitations: [COGNITIVE_LIMITATIONS] - Adaptations: [COGNITIVE_ADAPTATIONS]
- Physical limitations: [PHYSICAL_LIMITATIONS] - Accommodations: [PHYSICAL_ACCOMMODATIONS]
...
4. What can we expect: [PROGNOSIS_EXPLANATION] - Timeline: [EXPECTED_TIMELINE]

Pathophysiology (Simplified):
"Here's what's happening in your body: [PATHOPHYSIOLOGY_SIMPLE_EXPLANATION]"
- Normal function: [NORMAL_FUNCTION_EXPLANATION]
...
1. [MEDICATION_1]:
   ...
   - What to expect: [MEDICATION_EFFECTS_1] - Timeline: [EFFECT_TIMELINE_1]
   - Side effects to watch for: [SIDE_EFFECTS_1] - When to call: [WHEN_TO_CALL_1]
   - Important reminders: [MEDICATION_REMINDERS_1]

2. [MEDICATION_2]:
   - What it does: [MEDICATION_PURPOSE_2]
   - How to take it: [MEDICATION_INSTRUCTIONS_2]
   - What to expect: [MEDICATION_EFFECTS_2]
   - Side effects: [SIDE_EFFECTS_2]

Non-medication Treatments:
- [THERAPY_1]: Purpose [THERAPY_PURPOSE_1] - What to expect: [THERAPY_EXPECTATIONS_1]
...
- Preparation needed: [PROCEDURE_PREPARATION]
- What to expect during: [DURING_PROCEDURE_EXPECTATIONS]
- Recovery process: [RECOVERY_EXPLANATION]
- Risks and benefits: [RISK_BENEFIT_EXPLANATION]
...
- Portion guidance: [PORTION_GUIDANCE] - Practical tips: [PRACTICAL_DIET_TIPS]
...
- Starting slowly: [GRADUAL_INCREASE_PLAN]
...
1. [SYMPTOM_TO_MONITOR_1]:
   ...
   - Home management: [HOME_MANAGEMENT_1]
   - When to call provider: [CALL_CRITERIA_1]

2. [SYMPTOM_TO_MONITOR_2]:
   - What it feels like: [SYMPTOM_DESCRIPTION_2]
...
- Questions to ask: [SPECIALIST_QUESTIONS_TO_ASK]

Lab Work/Testing:
- Tests needed: [REQUIRED_TESTS] - Why: [TEST_REASONS]
...
- Your medications: [TEACH_BACK_MEDICATIONS]
...
- Concerns expressed: [PATIENT_CONCERNS_EXPRESSED]
- Barriers identified: [COMMUNICATION_BARRIERS_IDENTIFIED]
...
Patient Understanding: [UNDERSTANDING_LEVEL]
Next Communication: [NEXT_COMMUNICATION_PLAN]

Provider: [COMMUNICATING_PROVIDER]
...
✓ Understanding demonstrated: [UNDERSTANDING_STATUS]
✓ Resources provided: [RESOURCES_STATUS]
✓ Follow-up planned: [FOLLOWUP_STATUS]

Communication quality: [COMMUNICATION_QUALITY_RATING]
```

## Variables
[400+ variables covering comprehensive patient communication including assessment, education, counseling, adherence support, emotional care, cultural considerations, and documentation]
...
PATIENT_AUDIENCE: "45-year-old newly diagnosed diabetic"
HEALTH_TOPIC: "Type 2 diabetes management"
COMMUNICATION_SETTING: "Primary care clinic"
COMMUNICATION_APPROACH: "Patient-centered education"
COMMUNICATION_GOALS: "Understanding, acceptance, and self-management skills"
```

### Example 2: Medication Counseling
```
COMMUNICATION_TYPE: "Medication counseling session"
PATIENT_AUDIENCE: "Elderly patient with multiple medications"
HEALTH_TOPIC: "Complex medication regimen"
COMMUNICATION_SETTING: "Pharmacy consultation"
COMMUNICATION_APPROACH: "Simplified, visual education"
COMMUNICATION_GOALS: "Adherence improvement and safety"
```

### Example 3: Procedure Preparation
```
COMMUNICATION_TYPE: "Pre-procedure education"
PATIENT_AUDIENCE: "Anxious surgical patient"
HEALTH_TOPIC: "Cardiac catheterization"
COMMUNICATION_SETTING: "Hospital pre-admission"
COMMUNICATION_APPROACH: "Anxiety-reducing, detailed explanation"
COMMUNICATION_GOALS: "Reduced anxiety and informed consent"
```
...
1. Start with this template (Patient Communication Template)
...
- **Creating develop effective patient communication strategies including education, instructions, and counseling to improve health outcomes, adherence, and patient satisfaction.**: Combine this template with related analytics and strategy frameworks
