...
- framework
use_cases:
- Creating comprehensive framework for professional video production including pre-production
  planning, shooting protocols, post-production workflows, distribution strategies,
  team coordination, and quality control for creating high-impact video content.
...
| **Planning Component** | **Requirements** | **Timeline** | **Resources** | **Deliverables** | **Approval Process** |
|----------------------|---------------|------------|-------------|---------------|-------------------|
| Concept Development | [CONCEPT_REQ] | [CONCEPT_TIME] | [CONCEPT_RESOURCES] | [CONCEPT_DELIVER] | [CONCEPT_APPROVAL] |
| Script Writing | [SCRIPT_REQ] | [SCRIPT_TIME] | [SCRIPT_RESOURCES] | [SCRIPT_DELIVER] | [SCRIPT_APPROVAL] |
| Storyboarding | [STORY_REQ] | [STORY_TIME] | [STORY_RESOURCES] | [STORY_DELIVER] | [STORY_APPROVAL] |
| Location Scouting | [LOCATION_REQ] | [LOCATION_TIME] | [LOCATION_RESOURCES] | [LOCATION_DELIVER] | [LOCATION_APPROVAL] |
| Casting | [CASTING_REQ] | [CASTING_TIME] | [CASTING_RESOURCES] | [CASTING_DELIVER] | [CASTING_APPROVAL] |
| Production Design | [DESIGN_REQ] | [DESIGN_TIME] | [DESIGN_RESOURCES] | [DESIGN_DELIVER] | [DESIGN_APPROVAL] |

### 2. Technical Specifications & Equipment

**Production Tech Stack:**
```
Camera Systems:
Primary Cameras:
- Camera Model: [PRIMARY_CAMERA]
- Resolution: [CAMERA_RESOLUTION]
- Frame Rate: [FRAME_RATE]fps
- Codec: [CAMERA_CODEC]
- Color Space: [COLOR_SPACE]
- Backup Systems: [BACKUP_CAMERAS]

Lens Package:
- Prime Lenses: [PRIME_LENSES]
- Zoom Lenses: [ZOOM_LENSES]
- Specialty Lenses: [SPECIALTY_LENSES]
- Filters: [LENS_FILTERS]
- Matte Box: [MATTE_BOX]
...
- Wireless Systems: [WIRELESS_AUDIO]
...
|--------------------|-----------------|------------|----------------|-------------------|-------------------|
| Principal Photography | [PRINCIPAL_SCHEDULE] | [PRINCIPAL_SHOTS] | [PRINCIPAL_COVERAGE] | [PRINCIPAL_DATA] | [PRINCIPAL_QC] |
| B-Roll Capture | [BROLL_SCHEDULE] | [BROLL_SHOTS] | [BROLL_COVERAGE] | [BROLL_DATA] | [BROLL_QC] |
| Interview Segments | [INTERVIEW_SCHEDULE] | [INTERVIEW_SHOTS] | [INTERVIEW_COVERAGE] | [INTERVIEW_DATA] | [INTERVIEW_QC] |
| Action Sequences | [ACTION_SCHEDULE] | [ACTION_SHOTS] | [ACTION_COVERAGE] | [ACTION_DATA] | [ACTION_QC] |
| Pickup Shots | [PICKUP_SCHEDULE] | [PICKUP_SHOTS] | [PICKUP_COVERAGE] | [PICKUP_DATA] | [PICKUP_QC] |
| Wrap Procedures | [WRAP_SCHEDULE] | [WRAP_SHOTS] | [WRAP_COVERAGE] | [WRAP_DATA] | [WRAP_QC] |
...
Editorial Workflow:
Editing Process:
- Rough Cut: [ROUGH_CUT_TIME]
- Assembly Edit: [ASSEMBLY_EDIT]
- Fine Cut: [FINE_CUT]
- Picture Lock: [PICTURE_LOCK]
- Final Cut: [FINAL_CUT]
- Master Export: [MASTER_EXPORT]

Color Grading:
- Color Correction: [COLOR_CORRECTION]
- Look Development: [LOOK_DEV]
- Shot Matching: [SHOT_MATCHING]
- Creative Grading: [CREATIVE_GRADE]
...
- Audio Mixing: [AUDIO_MIX]
- Mastering: [AUDIO_MASTER]
```

### 5. Team Structure & Roles

| **Department** | **Key Roles** | **Responsibilities** | **Team Size** | **Daily Rate** | **Total Cost** |
|--------------|------------|-------------------|------------|--------------|--------------|
| Direction | [DIRECT_ROLES] | [DIRECT_RESPONSIBILITIES] | [DIRECT_SIZE] | $[DIRECT_RATE] | $[DIRECT_COST] |
| Camera | [CAMERA_ROLES] | [CAMERA_RESPONSIBILITIES] | [CAMERA_SIZE] | $[CAMERA_RATE] | $[CAMERA_COST] |
| Lighting | [LIGHT_ROLES] | [LIGHT_RESPONSIBILITIES] | [LIGHT_SIZE] | $[LIGHT_RATE] | $[LIGHT_COST] |
| Audio | [AUDIO_ROLES] | [AUDIO_RESPONSIBILITIES] | [AUDIO_SIZE] | $[AUDIO_RATE] | $[AUDIO_COST] |
| Production | [PROD_ROLES] | [PROD_RESPONSIBILITIES] | [PROD_SIZE] | $[PROD_RATE] | $[PROD_COST] |
| Post-Production | [POST_ROLES] | [POST_RESPONSIBILITIES] | [POST_SIZE] | $[POST_RATE] | $[POST_COST] |

### 6. Budget Management

**Production Budget Breakdown:**
| **Budget Category** | **Allocated Budget** | **Actual Spend** | **Variance** | **Contingency** | **Notes** |
|-------------------|------------------|---------------|------------|---------------|---------|
| Above-the-Line | $[ATL_BUDGET] | $[ATL_ACTUAL] | $[ATL_VARIANCE] | $[ATL_CONTINGENCY] | [ATL_NOTES] |
| Production | $[PROD_BUDGET] | $[PROD_ACTUAL] | $[PROD_VARIANCE] | $[PROD_CONTINGENCY] | [PROD_NOTES] |
| Post-Production | $[POST_BUDGET] | $[POST_ACTUAL] | $[POST_VARIANCE] | $[POST_CONTINGENCY] | [POST_NOTES] |
| Equipment | $[EQUIP_BUDGET] | $[EQUIP_ACTUAL] | $[EQUIP_VARIANCE] | $[EQUIP_CONTINGENCY] | [EQUIP_NOTES] |
| Locations | $[LOC_BUDGET] | $[LOC_ACTUAL] | $[LOC_VARIANCE] | $[LOC_CONTINGENCY] | [LOC_NOTES] |
| Marketing/Distribution | $[MARKET_BUDGET] | $[MARKET_ACTUAL] | $[MARKET_VARIANCE] | $[MARKET_CONTINGENCY] | [MARKET_NOTES] |
...
- Vimeo: [VIMEO_STRATEGY]
- Social Media: [SOCIAL_STRATEGY]
- Streaming Services: [STREAMING_STRATEGY]
- Broadcast TV: [BROADCAST_STRATEGY]
- Cinema Release: [CINEMA_STRATEGY]

Content Optimization:
- Format Versions: [FORMAT_VERSIONS]
- Aspect Ratios: [ASPECT_RATIOS]
- Resolution Options: [RESOLUTION_OPTIONS]
- Subtitle/Captions: [SUBTITLE_CAPTION]
...
- Trailer Release: [TRAILER_RELEASE]
...
| **QC Category** | **Standards** | **Review Process** | **Approval Levels** | **Revision Protocol** | **Sign-off Required** |
|---------------|------------|-----------------|------------------|--------------------|--------------------|
| Technical QC | [TECH_STANDARDS] | [TECH_REVIEW] | [TECH_APPROVAL] | [TECH_REVISION] | [TECH_SIGNOFF] |
| Creative QC | [CREATIVE_STANDARDS] | [CREATIVE_REVIEW] | [CREATIVE_APPROVAL] | [CREATIVE_REVISION] | [CREATIVE_SIGNOFF] |
| Audio QC | [AUDIO_STANDARDS] | [AUDIO_REVIEW] | [AUDIO_APPROVAL] | [AUDIO_REVISION] | [AUDIO_SIGNOFF] |
| Color QC | [COLOR_STANDARDS] | [COLOR_REVIEW] | [COLOR_APPROVAL] | [COLOR_REVISION] | [COLOR_SIGNOFF] |
| Legal/Compliance | [LEGAL_STANDARDS] | [LEGAL_REVIEW] | [LEGAL_APPROVAL] | [LEGAL_REVISION] | [LEGAL_SIGNOFF] |
| Final Delivery | [DELIVERY_STANDARDS] | [DELIVERY_REVIEW] | [DELIVERY_APPROVAL] | [DELIVERY_REVISION] | [DELIVERY_SIGNOFF] |

### 9. Marketing & Promotion

**Content Marketing Strategy:**
| **Marketing Channel** | **Content Type** | **Frequency** | **Budget** | **Target Audience** | **Performance Metrics** |
|---------------------|---------------|-------------|----------|-------------------|----------------------|
| Social Media | [SOCIAL_CONTENT] | [SOCIAL_FREQ] | $[SOCIAL_BUDGET] | [SOCIAL_AUDIENCE] | [SOCIAL_METRICS] |
| Email Marketing | [EMAIL_CONTENT] | [EMAIL_FREQ] | $[EMAIL_BUDGET] | [EMAIL_AUDIENCE] | [EMAIL_METRICS] |
| PR Outreach | [PR_CONTENT] | [PR_FREQ] | $[PR_BUDGET] | [PR_AUDIENCE] | [PR_METRICS] |
| Paid Advertising | [AD_CONTENT] | [AD_FREQ] | $[AD_BUDGET] | [AD_AUDIENCE] | [AD_METRICS] |
| Content Marketing | [CONTENT_TYPE] | [CONTENT_FREQ] | $[CONTENT_BUDGET] | [CONTENT_AUDIENCE] | [CONTENT_METRICS] |
| Event Marketing | [EVENT_CONTENT] | [EVENT_FREQ] | $[EVENT_BUDGET] | [EVENT_AUDIENCE] | [EVENT_METRICS] |

### 10. Performance Analytics & ROI
...
- Awards/Recognition: [AWARDS_RECOG]
- Client Satisfaction: [CLIENT_SAT]/10
- Team Performance: [TEAM_PERFORM]/10
```
...
Budget: $500K
Crew: 45 professionals
Shoot Days: 3
Post-Production: 4 weeks
Platforms: TV, digital, social
Results: 50M impressions, 15% sales lift
```
...
Distribution: Netflix, festivals
Impact: Emmy nomination, 10M views
```

### Example 3: YouTube Series
```
Format: Weekly episodes
Episode Length: 10-15 minutes
Budget: $5K per episode
Team: 5-person crew
Production: 2 episodes/week
Platform: YouTube, Instagram
Results: 1M subscribers, $30K monthly revenue
```
