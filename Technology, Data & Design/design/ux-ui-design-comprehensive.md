...
- Creating comprehensive UX/UI design strategies for wireframes, prototypes, design
  systems, user research, and testing to deliver exceptional user experiences across
  digital platforms and drive business success.
...
```
You are a professional UX/UI designer and user experience strategist with expertise in user research, interface design, interaction design, and usability testing. Create a detailed UX/UI design strategy based on the following information:
...
- User Base Size: [TARGET_AUDIENCE_SIZE]
- Market Position: [COMPETITIVE_POSITIONING]
- Revenue Model: [MONETIZATION_STRATEGY]
- Feature Scope: [FEATURE_REQUIREMENTS]
- Technical Constraints: [TECHNOLOGY_LIMITATIONS]
- Regulatory Requirements: [COMPLIANCE_NEEDS]

### User Research Context
- Target Users: [PRIMARY_USER_GROUPS]
- User Personas: [PERSONA_PROFILES]
- User Needs: [CORE_USER_NEEDS]
- Pain Points: [CURRENT_FRUSTRATIONS]
- Behavioral Patterns: [USAGE_BEHAVIORS]
- Demographics: [USER_DEMOGRAPHICS]
- Psychographics: [USER_MOTIVATIONS]
- Context of Use: [USAGE_SCENARIOS]

### Design Specifications
- Design System Requirements: [SYSTEM_SCOPE]
- Visual Style Direction: [AESTHETIC_APPROACH]
- Brand Guidelines: [BRAND_REQUIREMENTS]
- Accessibility Level: [ACCESSIBILITY_STANDARDS]
- Device Support: [DEVICE_COMPATIBILITY]
- Browser Support: [BROWSER_REQUIREMENTS]
- Performance Goals: [PERFORMANCE_TARGETS]
- Content Strategy: [CONTENT_APPROACH]

### User Experience Goals
- Primary UX Objectives: [UX_GOALS]
- User Journey Improvements: [JOURNEY_ENHANCEMENTS]
- Conversion Targets: [CONVERSION_OBJECTIVES]
- Engagement Metrics: [ENGAGEMENT_GOALS]
- Satisfaction Targets: [SATISFACTION_METRICS]
- Retention Goals: [RETENTION_OBJECTIVES]
- Accessibility Improvements: [ACCESSIBILITY_GOALS]
- Performance Enhancements: [PERFORMANCE_IMPROVEMENTS]

### Technical Requirements
- Frontend Framework: [FRONTEND_TECHNOLOGY]
- Design Tool Preferences: [DESIGN_TOOLS]
- Development Handoff: [HANDOFF_REQUIREMENTS]
- Asset Management: [ASSET_SYSTEM]
- Version Control: [VERSION_CONTROL_SYSTEM]
- Collaboration Tools: [COLLABORATION_PLATFORM]
- Testing Tools: [TESTING_PLATFORMS]
- Analytics Integration: [ANALYTICS_REQUIREMENTS]

Generate a comprehensive UX/UI design strategy that includes:

## EXECUTIVE SUMMARY
### Design Project Overview
- User experience strategy and vision
- Business alignment and value proposition
- Target audience and user research insights
...
- Wireframing and prototyping strategy
...
### 1.1 User Research Strategy
#### Research Methodology
##### Primary Research Methods
- User interviews and in-depth conversations
- Surveys and questionnaire distribution
...
- First-click testing for usability insights
...
- Industry report and whitepaper analysis
...
- Quantitative survey validation
- Interview confirmation and refinement
- Analytics data correlation
- Stakeholder feedback and alignment
- Customer service insight validation
- Sales team input and verification
- Market research data confirmation
- Ongoing persona evolution tracking

### 1.2 Competitive Analysis and Market Research
#### Competitive Landscape Assessment
##### Direct Competitor Analysis
- Feature comparison and gap analysis
- User experience audit and evaluation
- Visual design assessment and trends
...
##### Indirect Competitor Evaluation
- Alternative solution identification
- Cross-industry inspiration and trends
- Emerging technology and innovation
- User behavior pattern analysis
- Market disruption and opportunity
- Best practice identification and adoption
- Design pattern evolution and trends
- User expectation and standard setting
...
- Emotional journey mapping and sentiment
- Effort and friction point identification
- Drop-off and abandonment analysis
- Support request and escalation tracking
- User frustration and satisfaction measurement
- Process inefficiency and bottleneck discovery
- Technology barrier and limitation assessment
- Communication gap and misalignment identification

#### Future State Journey Design
##### Journey Optimization Strategy
- Experience vision and design principles
- Moment of truth enhancement and optimization
- Emotional peak and valley management
- Friction reduction and elimination
- Value delivery and benefit amplification
- Personalization and customization opportunity
- Omnichannel experience integration and consistency
- Continuous improvement and evolution planning

##### Service Design Integration
- Touchpoint orchestration and coordination
- Backend system and process alignment
...
- Service recovery and error handling protocol

## 2. INFORMATION ARCHITECTURE AND USER FLOWS
### 2.1 Information Architecture Design
#### Site Structure and Organization
##### Navigation Hierarchy Development
- Primary navigation structure and organization
- Secondary navigation and sub-menu design
- Tertiary navigation and contextual links
- Global navigation and utility links
- Footer navigation and sitemap structure
- Mobile navigation and hamburger menu design
- Search navigation and filtering system
- Breadcrumb navigation and wayfinding

##### Content Strategy and Taxonomy
- Content audit and inventory analysis
- Content categorization and classification
- Labeling system and nomenclature development
- Content relationship and linking strategy
- Search and findability optimization
- Content lifecycle and maintenance planning
- Multilingual content and localization strategy
- Content governance and ownership model

#### Card Sorting and Tree Testing
##### Card Sorting Methodology
- Open card sorting for category discovery
- Closed card sorting for structure validation
- Hybrid card sorting for optimization
- Remote vs. in-person testing approach
...
- Navigation path testing and optimization
- Success rate measurement and improvement
- Time to find information tracking
- User confidence and satisfaction assessment
- Failure point identification and resolution
- Alternative path discovery and support
- Search behavior and keyword analysis
- Mobile vs. desktop navigation comparison

### 2.2 User Flow Design and Optimization
#### Task Flow Documentation
##### Primary User Flows
- User registration and account creation
- Login and authentication process
- Core feature usage and interaction
...
#### Flow Optimization and Testing
##### Conversion Funnel Analysis
- Step-by-step conversion tracking
- Drop-off point identification and analysis
- Friction reduction and elimination strategy
- Alternative path and shortcut creation
...
- Trust signal and credibility enhancement

##### Flow Validation Methods
- User testing and task completion measurement
- Analytics tracking and behavior analysis
...
- Technical feasibility and constraint assessment
- Performance impact and optimization

### 2.3 Content Strategy and UX Writing
#### Content Architecture
##### Content Model Development
- Content type definition and specification
- Content attribute and metadata structure
- Content relationship and dependency mapping
- Content workflow and approval process
- Content template and standardization
- Content reuse and modularization strategy
- Content personalization and targeting
- Content performance and optimization tracking

##### Information Hierarchy
- Content prioritization and ranking
- Visual hierarchy and scanning pattern
- Progressive disclosure and layered information
- Content chunking and digestibility
- Scannability and readability optimization
- Call-out and emphasis strategy
- White space and breathing room utilization
...
- Personality trait and characteristic expression
...
- Success confirmation and reassurance
- Loading state and progress communication
- Empty state and onboarding guidance
- Form label and placeholder optimization
- Button text and action clarity
- Tooltip and help text effectiveness
- Navigation label and category naming

## 3. WIREFRAMING AND PROTOTYPING
### 3.1 Wireframing Strategy and Process
#### Low-Fidelity Wireframing
##### Concept Exploration
- Ideation and brainstorming visualization
- Layout exploration and variation testing
- Content placement and priority establishment
- Navigation structure and flow mapping
- Feature inclusion and exclusion decisions
- Screen relationship and transition planning
- Responsive behavior and adaptation preview
- Stakeholder communication and alignment

##### Rapid Iteration Process
- Sketch-based ideation and exploration
- Digital wireframing tool utilization
- Template and component library usage
- Collaborative creation and review
- Version control and change tracking
- Feedback integration and refinement
- Cross-platform consideration and adaptation
- Technical constraint and feasibility validation

#### High-Fidelity Wireframing
##### Detailed Layout Specification
- Precise measurement and spacing definition
- Grid system application and alignment
- Typography hierarchy and formatting
- Image and media placement optimization
- Interactive element positioning and sizing
- Form layout and field organization
- Navigation element and menu structure
- Content block and section arrangement

##### Annotation and Documentation
- Functionality specification and behavior
- Interaction state and transition description
- Content requirement and guideline
- Technical note and implementation detail
- Accessibility consideration and requirement
- Performance implication and constraint
- Device-specific behavior and adaptation
- Error state and edge case handling

### 3.2 Prototyping Methodology
#### Interactive Prototype Development
##### Prototype Fidelity Levels
- Paper prototype for concept validation
- Low-fidelity digital prototype for flow testing
- Medium-fidelity prototype for interaction design
- High-fidelity prototype for visual validation
- Code-based prototype for technical validation
- VR/AR prototype for immersive experience
- Voice prototype for conversational interface
- Multi-modal prototype for complex interaction

##### Prototype Tool Selection
- Tool capability and feature comparison
- Team skill and learning curve consideration
...
- Cost and licensing consideration
- Platform and device testing capability

#### Prototype Testing and Validation
##### User Testing Protocol
- Test objective and hypothesis definition
- Participant recruitment and screening
- Task scenario and script development
- Testing environment and setup preparation
- Data collection and recording method
- Success metric and measurement criteria
- Feedback analysis and insight extraction
- Iteration planning and implementation

##### Stakeholder Review Process
- Review objective and criteria establishment
- Stakeholder group and role identification
- Review format and presentation method
- Feedback collection and categorization
- Priority assessment and decision making
- Change request and modification process
- Approval workflow and sign-off procedure
- Communication and update distribution

### 3.3 Responsive Design and Multi-Platform Considerations
#### Responsive Design Strategy
##### Breakpoint Planning
- Mobile-first design approach and methodology
- Tablet and intermediate screen consideration
- Desktop and large screen optimization
- Ultra-wide and high-resolution display support
- Print and offline mode adaptation
- TV and smart display compatibility
- Wearable device and constraint consideration
- Emerging device and future-proofing

##### Adaptive Content Strategy
- Content prioritization and hierarchy adjustment
- Image and media optimization and scaling
- Navigation adaptation and menu transformation
- Interactive element touch and click optimization
- Typography scaling and readability maintenance
- Layout restructuring and component reordering
- Performance optimization and loading strategy
- Bandwidth and data usage consideration

#### Cross-Platform Design Consistency
##### Platform-Specific Guidelines
- iOS Human Interface Guidelines adherence
- Android Material Design principle application
- Web accessibility and usability standard
- Desktop application convention and expectation
- Platform-specific interaction pattern usage
- Native component and behavior utilization
- Performance optimization and constraint respect
- App store and marketplace requirement compliance

##### Design System Adaptation
- Component variation and platform customization
- Visual style and branding consistency maintenance
- Interaction pattern and behavior standardization
- Accessibility feature and support inclusion
- Localization and internationalization consideration
- Performance and technical constraint integration
- Testing and quality assurance across platforms
- Maintenance and update strategy coordination

## 4. VISUAL DESIGN SYSTEM
### 4.1 Design System Foundation
#### Visual Identity and Branding
##### Brand Expression in Digital Design
- Brand personality and characteristic translation
- Visual hierarchy and brand element prominence
- Color psychology and emotional association
- Typography choice and brand voice alignment
- Imagery style and photographic approach
- Iconography and symbol system development
- Pattern and texture usage and application
- Motion and animation brand personality

##### Brand Consistency Framework
- Brand guideline interpretation and application
- Cross-platform brand experience alignment
- Brand asset and resource management
- Brand compliance and quality assurance
- Brand evolution and adaptation strategy
- Brand extension and new feature integration
- Brand measurement and performance tracking
- Brand protection and misuse prevention

#### Design Token System
##### Token Architecture and Organization
- Color token definition and specification
- Typography token and scale establishment
- Spacing and layout token standardization
- Shadow and elevation token creation
- Border and radius token specification
- Animation and timing token development
- Breakpoint and grid token definition
- Asset and icon token organization

##### Token Management and Governance
- Token naming convention and consistency
- Token version control and change tracking
- Token distribution and synchronization
- Token validation and quality assurance
- Token documentation and usage guideline
- Token testing and compatibility verification
- Token migration and update process
- Token tool integration and automation

### 4.2 Component Library Development
#### Core Component Design
##### Basic Interface Elements
- Button component and state variation
- Input field and form element design
- Navigation component and menu system
- Card component and content container
- Modal and dialog component structure
- Table and data display component
- Icon and symbol component library
- Loading and progress component design

##### Advanced Component Systems
- Data visualization and chart component
- Media player and carousel component
- Calendar and date picker component
- Search and filter component system
- Notification and alert component
- File upload and attachment component
- Social sharing and interaction component
- Help and documentation component

#### Component Documentation and Standards
##### Usage Guidelines and Specifications
- Component anatomy and structure breakdown
- Property and customization option
- Usage example and implementation guide
- Do and don't recommendation and best practice
- Accessibility requirement and compliance
- Browser and device compatibility note
- Performance consideration and optimization
- Maintenance and update responsibility

##### Component Testing and Quality Assurance
- Visual regression testing and automation
- Accessibility testing and compliance verification
- Performance testing and optimization
- Cross-browser and device testing
- User testing and feedback incorporation
- Code quality and standard adherence
- Documentation accuracy and completeness
- Version control and release management

### 4.3 Layout and Grid System
#### Grid System Design
##### Grid Structure and Specification
- Column count and width calculation
- Gutter spacing and margin definition
- Container width and max-width specification
- Grid breakpoint and responsive behavior
- Nested grid and component alignment
- Asymmetric grid and creative layout support
- Grid debugging and development tool
- Grid performance and rendering optimization

##### Layout Pattern and Template
- Page layout template and structure
- Content block and section arrangement
- Sidebar and multi-column layout
- Header and footer component integration
- Navigation and menu positioning
- Form layout and field organization
- Dashboard and data-heavy interface
- Marketing and promotional page layout

#### Typography System
##### Font Selection and Hierarchy
- Primary and secondary font choice
- Font weight and style variation
- Font size scale and ratio system
- Line height and spacing optimization
- Letter spacing and character adjustment
- Font loading and performance strategy
- Font fallback and system integration
- Font licensing and legal compliance

##### Typographic Scale and Rhythm
- Modular scale and proportional system
- Vertical rhythm and baseline grid
- Text alignment and justification rule
- Paragraph spacing and text flow
- List styling and hierarchy
- Link styling and interaction state
- Quote and callout text treatment
...
- Form submission and processing state
- Error handling and message display
- Auto-complete and suggestion
- Multi-step form and progress indication
- File upload and attachment handling
- Real-time validation and feedback
- Form save and recovery functionality

#### Gesture and Touch Interface Design
##### Touch Gesture Recognition
- Tap and touch target optimization
- Swipe and scroll gesture handling
- Pinch and zoom functionality
- Long press and context menu
- Drag and drop interaction
- Multi-touch and complex gesture
- Gesture conflict and disambiguation
- Gesture accessibility and alternative
...
- Error handling and clarification request
- Context awareness and personalization
- Multi-modal interface integration
- Voice accessibility and inclusion

### 5.2 Micro-Interaction Design
#### Feedback and Response Systems
##### Visual Feedback Mechanisms
- Button press and interaction feedback
- Loading animation and progress indicator
- Success confirmation and celebration
- Error indication and warning signal
- Hover state and preview functionality
- Selection and highlight interaction
- Drag and drop visual cue
- System status and state communication

##### Audio and Haptic Feedback
- Sound effect and audio cue design
- Haptic feedback and vibration pattern
- Multi-sensory interaction and confirmation
- Accessibility and sensory alternative
- Cultural and contextual appropriateness
- User preference and customization
- Battery and performance consideration
- Platform and device capability integration

#### Animation and Motion Design
##### Animation Principles and Guidelines
- Disney animation principle adaptation
- Easing and timing function selection
- Duration and pacing optimization
- Choreography and sequence coordination
- Physics and natural movement simulation
...
- Page and screen transition animation
- Component state change visualization
- Data update and refresh animation
- Modal and overlay appearance
- Navigation and menu animation
- Content loading and skeleton screen
- Error state and recovery animation
- Celebration and achievement animation

### 5.3 Accessibility and Inclusive Design
#### Universal Design Principles
##### Inclusive Design Strategy
- Diverse user need and ability consideration
- Temporary and situational disability inclusion
- Age-related change and adaptation
- Cultural and linguistic diversity support
- Economic and technology constraint consideration
- Learning difference and cognitive accessibility
- Motor impairment and assistive technology
- Sensory impairment and alternative interface

##### Accessibility Implementation
- WCAG compliance and guideline adherence
...
- Sign language and visual interpretation
- Cognitive load and complexity reduction

#### Assistive Technology Integration
##### Screen Reader and Voice Control
- Semantic markup and structure optimization
...
- Dynamic content and live region
- Error message and form validation
- Help and instruction provision

##### Motor and Mobility Assistance
- Large touch target and click area
- Keyboard shortcut and alternative input
- Voice control and hands-free operation
- Switch and adaptive technology support
- Gesture simplification and alternative
- Time extension and pause functionality
- Auto-save and recovery capability
- Error prevention and correction assistance

## 6. USABILITY TESTING AND VALIDATION
### 6.1 Testing Strategy and Planning
...
### 6.2 Test Execution and Data Collection
...
### 6.3 Analysis and Insight Generation
...
## 7. DESIGN HANDOFF AND IMPLEMENTATION
### 7.1 Developer Collaboration and Communication
#### Design Specification Documentation
##### Technical Documentation Creation
- Component specification and behavior
- Layout and spacing measurement
- Color and typography specification
- Animation and transition detail
- Responsive behavior and breakpoint
- Accessibility requirement and guideline
- Browser and device compatibility note
- Performance consideration and optimization

##### Asset Organization and Delivery
- Image and icon asset preparation
- File format and optimization
- Naming convention and organization
- Version control and update management
- CDN and hosting consideration
...
- Living style guide creation and maintenance
- Pattern library organization and navigation
- Code example and implementation guide
- Design token integration and synchronization
- Version control and release management
...
- Browser support matrix and priority
- Device testing plan and coverage
- Operating system and version consideration
...
- User testing platform integration
- Analytics and feedback collection
- Continuous integration and deployment

#### Implementation Quality Control
##### Design Review and Approval Process
- Design-development comparison and validation
- Component functionality and behavior verification
- Visual accuracy and brand compliance
- Accessibility compliance and testing
- Performance requirement and benchmark
- User experience and usability validation
- Stakeholder review and approval
- Launch readiness and go-live checklist

##### Maintenance and Evolution Planning
- Design system governance and ownership
- Component library maintenance and update
...
### 7.3 Launch and Post-Launch Optimization
...
- Communication and announcement plan
...
### 8.1 Universal Design and Accessibility Standards
#### Accessibility Framework and Guidelines
##### WCAG Compliance Implementation
- Level A, AA, and AAA requirement understanding
- Perceivable design principle application
- Operable interface and interaction design
- Understandable content and instruction
- Robust technology and compatibility
- Testing methodology and validation
- Documentation and compliance tracking
- Legal requirement and risk management

##### Section 508 and ADA Compliance
- Federal accessibility requirement understanding
- Legal obligation and liability consideration
...
- Permanent and temporary disability inclusion
- Age-related change and adaptation
- Cultural and linguistic diversity
- Economic and technology constraint
- Educational and literacy difference
- Gender and identity consideration
- Religious and cultural sensitivity
- Geographic and regional variation

##### Design for Edge Cases
- Extreme use case and scenario
- Error condition and recovery
- Low bandwidth and connectivity
- Older technology and device
- Assistive technology compatibility
- Cognitive load and complexity
- Stress and emergency situation
- Multi-modal and alternative interface

### 8.2 Assistive Technology Integration
#### Screen Reader and Voice Technology
...
- Conversational flow and dialog
...
- Switch and single-button input
- Eye tracking and gaze control
- Head tracking and movement
...
- Large touch target and button
- Simplified gesture and interaction
- Reduced physical demand
- Alternative access path
- Time extension and pause
- Auto-save and recovery
- Error prevention and correction
- Customizable interface and control

### 8.3 Testing and Validation for Accessibility
...
- Cognitive walkthrough and assessment
- Content readability and comprehension
- Real-world usage and validation

#### Accessibility Feedback and Improvement
##### User Feedback Collection
- Accessible feedback mechanism
- Multiple communication channel
- User preference and customization
- Assistive technology user outreach
- Community engagement and participation
- Disability organization partnership
- Expert consultation and advice
- Continuous dialogue and relationship
...
### 9.1 User Experience Metrics and KPIs
...
### 9.2 Usability Testing and User Feedback
...
### 9.3 Performance Analytics and Optimization
...
### 10.2 Component Lifecycle and Maintenance
#### Component Development Process
##### Creation and Contribution Workflow
...
- Usage data analysis and insight
- Performance monitoring and optimization
- Component enhancement and addition
- Process improvement and efficiency
- Tool and platform optimization
...
- Technical constraint and requirement analysis
- Design principle and guideline establishment
- Project planning and resource allocation
- Team assembly and role definition

### Phase 2: Wireframing and Prototyping (Weeks 5-8)
- Information architecture and site map creation
- User flow and task flow documentation
- Low-fidelity wireframe creation and iteration
- Content strategy and UX writing development
- Interactive prototype creation and testing
- Stakeholder review and feedback integration
- High-fidelity prototype development
- User testing and validation

### Phase 3: Visual Design and System Development (Weeks 9-12)
- Visual design exploration and iteration
- Design system and component library creation
- Brand integration and style guide development
- Responsive design and multi-platform adaptation
...
- Comprehensive usability testing execution
- Accessibility audit and compliance verification
- Performance testing and optimization
- Cross-browser and device testing
- Stakeholder review and approval
- Design iteration and refinement
- Final asset and specification delivery
- Handoff preparation and coordination

### Phase 5: Implementation and Launch Support (Weeks 17-20)
...
## APPENDICES
- User research templates and questionnaires
- Persona and journey mapping frameworks
- Wireframing and prototyping checklists
- Design system documentation templates
- Accessibility testing and compliance guides
- Usability testing scripts and materials
- Performance measurement and analytics tools
- Design handoff and specification templates

Ensure the UX/UI design strategy is:
- User-centered and research-driven
- Business-aligned and value-focused
- Accessible and inclusive for all users
- Systematically designed and scalable
- Performance-optimized and efficient
- Collaboratively developed and documented
- Continuously tested and improved
- Strategically implemented and maintained
```

## Variables
- `[PROJECT_TITLE]`: Project name and identifier
- `[PRODUCT_CATEGORY]`: Product type (web app, mobile app, etc.)
- `[CURRENT_PHASE]`: Design phase (research, wireframe, prototype, etc.)
- `[PLATFORM_TYPE]`: Target platform (iOS, Android, web, desktop)
- `[PROJECT_DURATION]`: Timeline and schedule
- `[BUDGET_ALLOCATION]`: Budget constraints and resources
- `[TEAM_COMPOSITION]`: Team size and roles
- `[KEY_STAKEHOLDERS]`: Project stakeholders and decision makers
- `[PRIMARY_OBJECTIVES]`: Business goals and success criteria
- `[KPI_TARGETS]`: Key performance indicators and metrics
- `[TARGET_AUDIENCE_SIZE]`: User base and market size
- `[COMPETITIVE_POSITIONING]`: Market position and differentiation
- `[MONETIZATION_STRATEGY]`: Revenue model and approach
- `[FEATURE_REQUIREMENTS]`: Scope and functionality needs
- `[TECHNOLOGY_LIMITATIONS]`: Technical constraints and dependencies
- `[COMPLIANCE_NEEDS]`: Regulatory and legal requirements
- `[PRIMARY_USER_GROUPS]`: Target user segments and demographics
- `[PERSONA_PROFILES]`: User persona characteristics
- `[CORE_USER_NEEDS]`: Primary user needs and goals
- `[CURRENT_FRUSTRATIONS]`: Existing pain points and problems
- `[USAGE_BEHAVIORS]`: User behavior patterns and habits
- `[USER_DEMOGRAPHICS]`: Demographic characteristics
- `[USER_MOTIVATIONS]`: Psychographic insights and motivations
- `[USAGE_SCENARIOS]`: Context of use and environments
- `[SYSTEM_SCOPE]`: Design system requirements
- `[AESTHETIC_APPROACH]`: Visual style and design direction
- `[BRAND_REQUIREMENTS]`: Brand guidelines and standards
- `[ACCESSIBILITY_STANDARDS]`: Accessibility compliance level
- `[DEVICE_COMPATIBILITY]`: Supported devices and platforms
- `[BROWSER_REQUIREMENTS]`: Browser support matrix
- `[PERFORMANCE_TARGETS]`: Performance goals and metrics
- `[CONTENT_APPROACH]`: Content strategy and requirements
...
```
- Product Category: Mobile commerce application
- Platform: iOS and Android native apps
- Users: Online shoppers aged 25-45
- Goal: Improve conversion rates and user experience
- Phase: High-fidelity prototype and testing
```

### Example 2: SaaS Dashboard
```
- Product Category: Business intelligence web application
- Platform: Responsive web application
- Users: Business analysts and data professionals
- Goal: Simplify complex data visualization
- Phase: Design system and component library
```

### Example 3: Healthcare Patient Portal
```
- Product Category: Healthcare management platform
- Platform: Cross-platform web and mobile
- Users: Patients and healthcare providers
- Goal: Improve accessibility and usability
- Phase: User research and wireframing
```
...
1. Start with this template (UX/UI Design Template Generator)
...
- **Creating comprehensive UX/UI design strategies for wireframes, prototypes, design systems, user research, and testing to deliver exceptional user experiences across digital platforms and drive business success.**: Combine this template with related analytics and strategy frameworks
- **Project planning and execution**: Combine this template with related analytics and strategy frameworks
- **Strategy development**: Combine this template with related analytics and strategy frameworks

## Customization Options

### 1. Design Phase Focus
Adapt template for specific design phases (research, wireframing, prototyping, visual design, testing) with phase-specific deliverables and methods.

### 2. Platform Specialization
Customize for target platforms (mobile apps, web applications, desktop software, cross-platform) with platform-specific guidelines and constraints.

### 3. Industry Vertical
Tailor approach for specific industries (healthcare, finance, e-commerce, education) with industry-specific requirements and regulations.

### 4. Accessibility Level
Adjust accessibility requirements and testing based on compliance needs (WCAG A, AA, AAA) and user population.

### 5. Project Scale
Scale complexity and resource requirements based on project size, budget, and timeline constraints.