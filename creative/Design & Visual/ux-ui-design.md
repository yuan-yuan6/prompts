...
```
You are a UX/UI design expert. Create [DESIGN_TYPE] for [PRODUCT_NAME] targeting [USER_GROUP] with a focus on [DESIGN_GOAL].

DESIGN PROJECT BRIEF:
Project Overview:
- Project name: [PROJECT_NAME]
- Product type: [PRODUCT_TYPE] (Web App/Mobile App/Desktop/Cross-platform)
- Design phase: [DESIGN_PHASE] (Research/Concept/Wireframe/Prototype/Final)
...
- Behavioral patterns: [USER_BEHAVIORS]
...
- User flow testing: [FLOW_PROTOTYPE]
- Basic interactions: [BASIC_INTERACTIONS]
- Navigation testing: [NAV_TESTING]
- Content hierarchy: [CONTENT_HIERARCHY]

High-Fidelity Prototype:
- Visual design: [VISUAL_PROTOTYPE]
...
- Radio buttons: [RADIO_COMPONENT]
- Toggle switches: [TOGGLE_COMPONENT]
...
- Click animations: [CLICK_ANIMATIONS]
- Loading animations: [LOADING_ANIMATIONS]
- Progress indicators: [PROGRESS_INDICATORS]

Touch Interactions (Mobile):
- Tap gestures: [TAP_GESTURES]
- Swipe actions: [SWIPE_ACTIONS]
...
- Mobile typography: [MOBILE_TYPOGRAPHY]
- Thumb-friendly design: [THUMB_DESIGN]

Tablet Design ([TABLET_SIZE]):
- Multi-column layouts: [TABLET_COLUMNS]
- Orientation handling: [ORIENTATION_SUPPORT]
- Touch interactions: [TABLET_TOUCH]
- Hybrid navigation: [HYBRID_NAV]
- Content density: [CONTENT_DENSITY]

Desktop Design ([DESKTOP_SIZE]):
- Advanced layouts: [DESKTOP_LAYOUTS]
- Sidebar navigation: [SIDEBAR_NAV]
- Multi-panel interfaces: [MULTI_PANEL]
- Keyboard shortcuts: [KEYBOARD_SHORTCUTS]
- Advanced features: [DESKTOP_FEATURES]

Large Screen ([LARGE_SCREEN_SIZE]):
- Ultra-wide support: [ULTRAWIDE_SUPPORT]
- Multi-column content: [MULTI_COLUMN]
...
OUTPUT: Deliver complete UX/UI design with:
1. Comprehensive wireframes
...
## Variables
[All 400+ variables for comprehensive UX/UI design including wireframes, prototypes, and systems]
...
PRODUCT_NAME: "StyleHub Fashion App"
USER_GROUP: "Fashion-conscious millennials"
DESIGN_GOAL: "Seamless shopping experience"
PRODUCT_TYPE: "Mobile App"
DESIGN_PHASE: "High-fidelity prototype"
```

### Example 2: SaaS Dashboard
```
DESIGN_TYPE: "Web application design system"
PRODUCT_NAME: "DataViz Analytics Platform"
USER_GROUP: "Business analysts and data scientists"
DESIGN_GOAL: "Intuitive data visualization"
PRODUCT_TYPE: "Web App"
DESIGN_PHASE: "Design system creation"
```

### Example 3: Healthcare Portal
```
DESIGN_TYPE: "Patient portal wireframes"
PRODUCT_NAME: "MedConnect Health Portal"
USER_GROUP: "Patients and healthcare providers"
DESIGN_GOAL: "Accessible healthcare management"
PRODUCT_TYPE: "Cross-platform"
DESIGN_PHASE: "Wireframe and prototype"
```
