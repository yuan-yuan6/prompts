...
| **Problem Dimension** | **Current State** | **Root Causes** | **Contributing Factors** | **Stakeholder Impact** | **Evidence Base** |
|---------------------|-----------------|---------------|----------------------|-------------------|-----------------|
| Primary Problem | [PRIMARY_PROBLEM] | [PRIMARY_CAUSES] | [PRIMARY_FACTORS] | [PRIMARY_IMPACT] | [PRIMARY_EVIDENCE] |
| Secondary Issues | [SECONDARY_ISSUES] | [SECONDARY_CAUSES] | [SECONDARY_FACTORS] | [SECONDARY_IMPACT] | [SECONDARY_EVIDENCE] |
| System Failures | [SYSTEM_FAILURES] | [SYSTEM_CAUSES] | [SYSTEM_FACTORS] | [SYSTEM_IMPACT] | [SYSTEM_EVIDENCE] |
| Barriers | [BARRIERS] | [BARRIER_CAUSES] | [BARRIER_FACTORS] | [BARRIER_IMPACT] | [BARRIER_EVIDENCE] |
| Opportunities | [OPPORTUNITIES] | [OPP_ENABLERS] | [OPP_FACTORS] | [OPP_IMPACT] | [OPP_EVIDENCE] |
| Context | [CONTEXT] | [CONTEXT_DRIVERS] | [CONTEXT_FACTORS] | [CONTEXT_IMPACT] | [CONTEXT_EVIDENCE] |

### 2. Impact & Outcome Hierarchy
...
- Population Effect: [POPULATION_EFFECT]
...
- Market Development: [MARKET_DEV]
- Network Effects: [NETWORK_EFFECTS]
- Measurement: [MED_MEASUREMENT]

Short-term Outcomes (1-2 years):
- Knowledge Increase: [KNOWLEDGE_INC]
- Skill Development: [SKILL_DEV]
- Attitude Shift: [ATTITUDE_SHIFT]
- Access Improvement: [ACCESS_IMPROVE]
...
|----------------------|-------------|---------------|------------------|---------------------|-------------------|
| Direct Service | [DIRECT_ACTIVITIES] | [DIRECT_TARGET] | [DIRECT_METHOD] | [DIRECT_RESOURCES] | [DIRECT_SUCCESS] |
| Capacity Building | [CAPACITY_ACTIVITIES] | [CAPACITY_TARGET] | [CAPACITY_METHOD] | [CAPACITY_RESOURCES] | [CAPACITY_SUCCESS] |
| Systems Change | [SYSTEMS_ACTIVITIES] | [SYSTEMS_TARGET] | [SYSTEMS_METHOD] | [SYSTEMS_RESOURCES] | [SYSTEMS_SUCCESS] |
| Advocacy | [ADVOCACY_ACTIVITIES] | [ADVOCACY_TARGET] | [ADVOCACY_METHOD] | [ADVOCACY_RESOURCES] | [ADVOCACY_SUCCESS] |
| Research & Learning | [RESEARCH_ACTIVITIES] | [RESEARCH_TARGET] | [RESEARCH_METHOD] | [RESEARCH_RESOURCES] | [RESEARCH_SUCCESS] |
| Partnership | [PARTNER_ACTIVITIES] | [PARTNER_TARGET] | [PARTNER_METHOD] | [PARTNER_RESOURCES] | [PARTNER_SUCCESS] |
...
- Demographics: [BENEFICIARY_DEMO]
- Needs Assessment: [BENEFICIARY_NEEDS]
- Participation Level: [BENEFICIARY_PART]
- Feedback Mechanism: [BENEFICIARY_FEEDBACK]
- Empowerment Strategy: [BENEFICIARY_EMPOWER]

Implementation Partners:
- Core Partners: [CORE_PARTNERS]
- Roles & Responsibilities: [PARTNER_ROLES]
- Coordination Mechanism: [PARTNER_COORD]
...
| **Assumption Category** | **Key Assumptions** | **Evidence Level** | **Risk if False** | **Mitigation Strategy** | **Monitoring Plan** |
|-----------------------|-------------------|------------------|-----------------|----------------------|-------------------|
| Causal Links | [CAUSAL_ASSUMPTIONS] | [CAUSAL_EVIDENCE] | [CAUSAL_RISK] | [CAUSAL_MITIGATE] | [CAUSAL_MONITOR] |
| Context | [CONTEXT_ASSUMPTIONS] | [CONTEXT_EVIDENCE] | [CONTEXT_RISK] | [CONTEXT_MITIGATE] | [CONTEXT_MONITOR] |
| Resources | [RESOURCE_ASSUMPTIONS] | [RESOURCE_EVIDENCE] | [RESOURCE_RISK] | [RESOURCE_MITIGATE] | [RESOURCE_MONITOR] |
| Stakeholders | [STAKE_ASSUMPTIONS] | [STAKE_EVIDENCE] | [STAKE_RISK] | [STAKE_MITIGATE] | [STAKE_MONITOR] |
| External Factors | [EXTERNAL_ASSUMPTIONS] | [EXTERNAL_EVIDENCE] | [EXTERNAL_RISK] | [EXTERNAL_MITIGATE] | [EXTERNAL_MONITOR] |
| Sustainability | [SUSTAIN_ASSUMPTIONS] | [SUSTAIN_EVIDENCE] | [SUSTAIN_RISK] | [SUSTAIN_MITIGATE] | [SUSTAIN_MONITOR] |

### 6. Monitoring & Evaluation Framework

**M&E System Design:**
| **M&E Component** | **Approach** | **Methods** | **Frequency** | **Responsibility** | **Use of Data** |
|------------------|------------|-----------|-------------|------------------|---------------|
| Process Monitoring | [PROCESS_APPROACH] | [PROCESS_METHODS] | [PROCESS_FREQ] | [PROCESS_RESP] | [PROCESS_USE] |
| Outcome Monitoring | [OUTCOME_APPROACH] | [OUTCOME_METHODS] | [OUTCOME_FREQ] | [OUTCOME_RESP] | [OUTCOME_USE] |
| Impact Evaluation | [IMPACT_APPROACH] | [IMPACT_METHODS] | [IMPACT_FREQ] | [IMPACT_RESP] | [IMPACT_USE] |
| Learning Systems | [LEARNING_APPROACH] | [LEARNING_METHODS] | [LEARNING_FREQ] | [LEARNING_RESP] | [LEARNING_USE] |
| Reporting | [REPORT_APPROACH] | [REPORT_METHODS] | [REPORT_FREQ] | [REPORT_RESP] | [REPORT_USE] |
| Quality Assurance | [QUALITY_APPROACH] | [QUALITY_METHODS] | [QUALITY_FREQ] | [QUALITY_RESP] | [QUALITY_USE] |
...
Resource Planning:
Human Resources:
- Program Staff: [PROGRAM_STAFF] FTE
- Technical Experts: [TECH_EXPERTS]
- Support Staff: [SUPPORT_STAFF]
- Volunteers: [VOLUNTEERS]
- Consultants: [CONSULTANTS]
- Total HR Cost: $[HR_COST]

Financial Resources:
- Direct Program: $[DIRECT_COST]
- Capacity Building: $[CAPACITY_COST]
...
| **Phase** | **Duration** | **Key Milestones** | **Deliverables** | **Success Criteria** | **Decision Points** |
|----------|------------|------------------|----------------|-------------------|-------------------|
| Inception | [INCEPT_DURATION] | [INCEPT_MILESTONES] | [INCEPT_DELIVER] | [INCEPT_CRITERIA] | [INCEPT_DECISIONS] |
| Pilot | [PILOT_DURATION] | [PILOT_MILESTONES] | [PILOT_DELIVER] | [PILOT_CRITERIA] | [PILOT_DECISIONS] |
| Scale-up | [SCALE_DURATION] | [SCALE_MILESTONES] | [SCALE_DELIVER] | [SCALE_CRITERIA] | [SCALE_DECISIONS] |
| Full Implementation | [FULL_DURATION] | [FULL_MILESTONES] | [FULL_DELIVER] | [FULL_CRITERIA] | [FULL_DECISIONS] |
| Sustainability | [SUSTAIN_DURATION] | [SUSTAIN_MILESTONES] | [SUSTAIN_DELIVER] | [SUSTAIN_CRITERIA] | [SUSTAIN_DECISIONS] |
| Exit Strategy | [EXIT_DURATION] | [EXIT_MILESTONES] | [EXIT_DELIVER] | [EXIT_CRITERIA] | [EXIT_DECISIONS] |

### 9. Learning & Adaptation

**Adaptive Management Framework:**
| **Learning Area** | **Questions** | **Data Sources** | **Analysis Method** | **Decision Process** | **Implementation** |
|------------------|-------------|----------------|-------------------|--------------------|--------------------|
| Program Design | [DESIGN_QUESTIONS] | [DESIGN_DATA] | [DESIGN_ANALYSIS] | [DESIGN_DECISION] | [DESIGN_IMPLEMENT] |
| Implementation | [IMPL_QUESTIONS] | [IMPL_DATA] | [IMPL_ANALYSIS] | [IMPL_DECISION] | [IMPL_IMPLEMENT] |
| Outcomes | [OUTCOME_QUESTIONS] | [OUTCOME_DATA] | [OUTCOME_ANALYSIS] | [OUTCOME_DECISION] | [OUTCOME_IMPLEMENT] |
| Context Changes | [CONTEXT_QUESTIONS] | [CONTEXT_DATA] | [CONTEXT_ANALYSIS] | [CONTEXT_DECISION] | [CONTEXT_IMPLEMENT] |
| Innovation | [INNOV_QUESTIONS] | [INNOV_DATA] | [INNOV_ANALYSIS] | [INNOV_DECISION] | [INNOV_IMPLEMENT] |
| Scale & Sustainability | [SCALE_QUESTIONS] | [SCALE_DATA] | [SCALE_ANALYSIS] | [SCALE_DECISION] | [SCALE_IMPLEMENT] |

### 10. Impact & Sustainability Strategy

```
Sustainability Framework:
Financial Sustainability:
- Revenue Diversification: [REVENUE_DIVERS]
- Cost Recovery: [COST_RECOVERY]%
- Funding Pipeline: [FUNDING_PIPE]
- Financial Reserves: [FIN_RESERVES]
- Business Model: [BUSINESS_MODEL]

Institutional Sustainability:
- Organizational Capacity: [ORG_CAPACITY]
...
- Green Practices: [GREEN_PRACTICE]
...
Problem: 40% illiteracy rate
Target: 10,000 students
Theory: Teacher training → improved instruction → better reading outcomes
Activities: Training, materials, mentoring
Outcomes: 80% reading proficiency
Impact: Breaking poverty cycle
Timeline: 3-year program
```

### Example 2: Health Initiative
```
Program: Maternal health improvement
Issue: High maternal mortality
Beneficiaries: 50,000 women
Intervention: Community health workers + facility upgrades
Outcomes: 50% reduction in mortality
Sustainability: Government integration
Budget: $5M over 5 years
M&E: Randomized control trial
```

### Example 3: Economic Development
```
Program: Microenterprise development
Target: 1,000 entrepreneurs
Theory: Capital + training → business growth → job creation
Activities: Loans, training, mentoring, market linkages
Impact: 5,000 jobs created
Sustainability: Revolving fund model
