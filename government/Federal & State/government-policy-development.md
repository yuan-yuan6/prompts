...
### 1. Policy Context & Problem Definition

| **Analysis Area** | **Current State** | **Desired State** | **Gap Analysis** | **Priority Score** | **Resource Need** |
|------------------|------------------|------------------|-----------------|-------------------|------------------|
| Economic Impact | [ECON_CURRENT] | [ECON_DESIRED] | [ECON_GAP] | [ECON_PRIORITY]/10 | $[ECON_RESOURCE] |
| Social Impact | [SOCIAL_CURRENT] | [SOCIAL_DESIRED] | [SOCIAL_GAP] | [SOCIAL_PRIORITY]/10 | $[SOCIAL_RESOURCE] |
| Environmental | [ENV_CURRENT] | [ENV_DESIRED] | [ENV_GAP] | [ENV_PRIORITY]/10 | $[ENV_RESOURCE] |
| Public Health | [HEALTH_CURRENT] | [HEALTH_DESIRED] | [HEALTH_GAP] | [HEALTH_PRIORITY]/10 | $[HEALTH_RESOURCE] |
| Infrastructure | [INFRA_CURRENT] | [INFRA_DESIRED] | [INFRA_GAP] | [INFRA_PRIORITY]/10 | $[INFRA_RESOURCE] |
| Legal/Regulatory | [LEGAL_CURRENT] | [LEGAL_DESIRED] | [LEGAL_GAP] | [LEGAL_PRIORITY]/10 | $[LEGAL_RESOURCE] |
...
- Citizens/Residents: [CITIZEN_COUNT]
  Impact Level: [CITIZEN_IMPACT]
  Engagement Method: [CITIZEN_ENGAGE]
  Feedback Mechanism: [CITIZEN_FEEDBACK]

- Government Agencies: [AGENCY_LIST]
  Coordination Level: [AGENCY_COORD]
  Resource Sharing: [AGENCY_RESOURCE]
  Integration Points: [AGENCY_INTEGRATE]

- Private Sector: [PRIVATE_ENTITIES]
  Partnership Type: [PRIVATE_PARTNER]
  Investment Level: [PRIVATE_INVEST]
  Compliance Requirements: [PRIVATE_COMPLY]

- NGOs/Community Groups: [NGO_LIST]
  Role: [NGO_ROLE]
  Capacity Building: [NGO_CAPACITY]
  Service Delivery: [NGO_SERVICE]

- Special Interest Groups: [SPECIAL_GROUPS]
...
|------------------|------------------------|--------------|------------------|-------------------------|---------------|
| Option A: [OPTION_A] | $[COST_A] | [TIME_A] | [EFFECT_A]/10 | [FEASIBLE_A]/10 | [RISK_A]/10 |
| Option B: [OPTION_B] | $[COST_B] | [TIME_B] | [EFFECT_B]/10 | [FEASIBLE_B]/10 | [RISK_B]/10 |
| Option C: [OPTION_C] | $[COST_C] | [TIME_C] | [EFFECT_C]/10 | [FEASIBLE_C]/10 | [RISK_C]/10 |
| Hybrid: [OPTION_HYBRID] | $[COST_HYBRID] | [TIME_HYBRID] | [EFFECT_HYBRID]/10 | [FEASIBLE_HYBRID]/10 | [RISK_HYBRID]/10 |
| Status Quo | $[COST_SQ] | N/A | [EFFECT_SQ]/10 | [FEASIBLE_SQ]/10 | [RISK_SQ]/10 |

### 4. Regulatory & Legislative Framework

**Legal Implementation Path:**
| **Component** | **Current Law** | **Required Changes** | **Legislative Process** | **Timeline** | **Opposition** |
|--------------|----------------|---------------------|------------------------|-------------|---------------|
| Federal Law | [FED_CURRENT] | [FED_CHANGES] | [FED_PROCESS] | [FED_TIME] | [FED_OPPOSE] |
| State Law | [STATE_CURRENT] | [STATE_CHANGES] | [STATE_PROCESS] | [STATE_TIME] | [STATE_OPPOSE] |
| Local Ordinance | [LOCAL_CURRENT] | [LOCAL_CHANGES] | [LOCAL_PROCESS] | [LOCAL_TIME] | [LOCAL_OPPOSE] |
| Administrative Rule | [ADMIN_CURRENT] | [ADMIN_CHANGES] | [ADMIN_PROCESS] | [ADMIN_TIME] | [ADMIN_OPPOSE] |
| Executive Order | [EXEC_CURRENT] | [EXEC_CHANGES] | [EXEC_PROCESS] | [EXEC_TIME] | [EXEC_OPPOSE] |
...
- Legislative Approval: [LEG_APPROVAL]
- Budget Allocation: [BUDGET_ALLOC]
- Staff Recruitment: [STAFF_RECRUIT]
- System Development: [SYSTEM_DEV]
- Training Programs: [TRAINING_PROG]

Phase 2 - Pilot Program ([PILOT_DURATION]):
- Test Locations: [PILOT_LOCATIONS]
- Participant Count: [PILOT_PARTICIPANTS]
- Metrics Tracked: [PILOT_METRICS]
- Feedback Collection: [PILOT_FEEDBACK]
- Adjustments Made: [PILOT_ADJUST]

Phase 3 - Full Rollout ([ROLLOUT_DURATION]):
- Geographic Coverage: [ROLLOUT_COVERAGE]
- Service Points: [ROLLOUT_POINTS]
- Capacity Building: [ROLLOUT_CAPACITY]
- Public Communication: [ROLLOUT_COMM]
- Support Systems: [ROLLOUT_SUPPORT]

Phase 4 - Optimization ([OPTIMIZE_DURATION]):
- Performance Review: [OPTIMIZE_REVIEW]
- Process Improvements: [OPTIMIZE_PROCESS]
- Technology Upgrades: [OPTIMIZE_TECH]
- Scale Adjustments: [OPTIMIZE_SCALE]
```

### 6. Budget & Resource Allocation

| **Budget Category** | **Year 1** | **Year 2** | **Year 3** | **5-Year Total** | **ROI** |
|-------------------|-----------|-----------|-----------|-----------------|---------|
| Personnel | $[PERSON_Y1] | $[PERSON_Y2] | $[PERSON_Y3] | $[PERSON_5Y] | [PERSON_ROI]x |
| Technology | $[TECH_Y1] | $[TECH_Y2] | $[TECH_Y3] | $[TECH_5Y] | [TECH_ROI]x |
| Infrastructure | $[INFRA_Y1] | $[INFRA_Y2] | $[INFRA_Y3] | $[INFRA_5Y] | [INFRA_ROI]x |
| Programs/Services | $[PROG_Y1] | $[PROG_Y2] | $[PROG_Y3] | $[PROG_5Y] | [PROG_ROI]x |
| Communications | $[COMM_Y1] | $[COMM_Y2] | $[COMM_Y3] | $[COMM_5Y] | [COMM_ROI]x |
| Contingency | $[CONT_Y1] | $[CONT_Y2] | $[CONT_Y3] | $[CONT_5Y] | N/A |

### 7. Public Consultation & Engagement

**Community Engagement Strategy:**
| **Method** | **Reach** | **Frequency** | **Cost** | **Effectiveness** | **Feedback Quality** |
|-----------|----------|--------------|---------|------------------|-------------------|
| Town Halls | [TOWN_REACH] | [TOWN_FREQ] | $[TOWN_COST] | [TOWN_EFFECT]/10 | [TOWN_QUALITY]/10 |
| Online Surveys | [SURVEY_REACH] | [SURVEY_FREQ] | $[SURVEY_COST] | [SURVEY_EFFECT]/10 | [SURVEY_QUALITY]/10 |
| Focus Groups | [FOCUS_REACH] | [FOCUS_FREQ] | $[FOCUS_COST] | [FOCUS_EFFECT]/10 | [FOCUS_QUALITY]/10 |
| Advisory Committees | [ADVISORY_REACH] | [ADVISORY_FREQ] | $[ADVISORY_COST] | [ADVISORY_EFFECT]/10 | [ADVISORY_QUALITY]/10 |
| Digital Platforms | [DIGITAL_REACH] | [DIGITAL_FREQ] | $[DIGITAL_COST] | [DIGITAL_EFFECT]/10 | [DIGITAL_QUALITY]/10 |
...
|------------------|----------------|-----------|---------------|----------------------|-------------------|
| Political Risk | [POL_PROB]% | [POL_IMPACT]/10 | [POL_SCORE] | [POL_MITIGATE] | [POL_CONTINGENCY] |
| Financial Risk | [FIN_PROB]% | [FIN_IMPACT]/10 | [FIN_SCORE] | [FIN_MITIGATE] | [FIN_CONTINGENCY] |
| Operational Risk | [OP_PROB]% | [OP_IMPACT]/10 | [OP_SCORE] | [OP_MITIGATE] | [OP_CONTINGENCY] |
| Legal Risk | [LEG_PROB]% | [LEG_IMPACT]/10 | [LEG_SCORE] | [LEG_MITIGATE] | [LEG_CONTINGENCY] |
| Reputational Risk | [REP_PROB]% | [REP_IMPACT]/10 | [REP_SCORE] | [REP_MITIGATE] | [REP_CONTINGENCY] |
| Technology Risk | [TECH_PROB]% | [TECH_IMPACT]/10 | [TECH_SCORE] | [TECH_MITIGATE] | [TECH_CONTINGENCY] |

### 10. Sustainability & Long-term Planning

**Sustainability Framework:**
| **Dimension** | **5-Year Goal** | **10-Year Vision** | **Success Factors** | **Challenges** | **Adaptation Strategy** |
|--------------|----------------|-------------------|-------------------|---------------|----------------------|
| Financial | [FIN_5YEAR] | [FIN_10YEAR] | [FIN_SUCCESS] | [FIN_CHALLENGE] | [FIN_ADAPT] |
| Institutional | [INST_5YEAR] | [INST_10YEAR] | [INST_SUCCESS] | [INST_CHALLENGE] | [INST_ADAPT] |
| Social | [SOC_5YEAR] | [SOC_10YEAR] | [SOC_SUCCESS] | [SOC_CHALLENGE] | [SOC_ADAPT] |
| Environmental | [ENV_5YEAR] | [ENV_10YEAR] | [ENV_SUCCESS] | [ENV_CHALLENGE] | [ENV_ADAPT] |
...
Policy Area: Universal healthcare access
Population: 10 million residents
Budget: $5 billion over 5 years
Implementation: Phased rollout over 3 years
Outcomes: 95% coverage, 30% cost reduction
Key Features: Public option, subsidized premiums
```

### Example 2: Climate Action Policy
```
Agency: Environmental Protection Agency
Policy Area: Carbon emissions reduction
Target: 50% reduction by 2030
Budget: $2 billion annual
Mechanisms: Carbon tax, renewable incentives
Stakeholders: Industry, utilities, citizens
Monitoring: Real-time emissions tracking
```

### Example 3: Education Reform Initiative
```
Agency: Department of Education
Policy Area: K-12 achievement gap
Students Affected: 500,000
Budget: $1 billion over 4 years
Programs: Teacher training, technology access
