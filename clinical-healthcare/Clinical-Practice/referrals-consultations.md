...
use_cases:
- Creating comprehensive referral letters, consultation summaries, and specialist
  communication to ensure effective care coordination and optimal patient outcomes.
...
```
You are a healthcare communication specialist. Create [REFERRAL_TYPE] for [PATIENT_CASE] to [SPECIALIST_RECIPIENT] regarding [REFERRAL_REASON] with [URGENCY_LEVEL] priority for [CONSULTATION_PURPOSE].
...
- Phone: [REFERRING_PHONE] - Fax: [REFERRING_FAX]
...
2. [MEDICATION_2] - Dose: [DOSE_2] - Frequency: [FREQUENCY_2] - Start date: [START_DATE_2]
   - Indication: [INDICATION_2] - Response: [RESPONSE_2] - Side effects: [SIDE_EFFECTS_2]

3. [MEDICATION_3] - Dose: [DOSE_3] - Frequency: [FREQUENCY_3] - Start date: [START_DATE_3]
   - Indication: [INDICATION_3] - Response: [RESPONSE_3]

4. [MEDICATION_4] - Dose: [DOSE_4] - Frequency: [FREQUENCY_4] - Start date: [START_DATE_4]

Over-the-counter/Supplements:
- [OTC_MED_1]: [OTC_DOSE_1] - Purpose: [OTC_PURPOSE_1]
...
- Exercise habits: [EXERCISE_HABITS] - Frequency: [EXERCISE_FREQUENCY]
- Diet: [DIETARY_HABITS] - Special diets: [SPECIAL_DIETS]
...
- Temperature: [TEMPERATURE] - Route: [TEMPERATURE_ROUTE]
- Respiratory rate: [RESPIRATORY_RATE] - Pattern: [BREATHING_PATTERN]
- Oxygen saturation: [OXYGEN_SATURATION] - On room air/supplemental O2: [OXYGEN_DELIVERY]
...
- [RELEVANT_SYSTEM_3]: [RELEVANT_FINDINGS_3]

Complete Physical Exam (if performed):
HEENT: [HEENT_FINDINGS]
Neck: [NECK_FINDINGS]
Cardiovascular: [CV_FINDINGS]
Respiratory: [RESPIRATORY_FINDINGS]
Abdominal: [ABDOMINAL_FINDINGS]
...
- [SPECIALTY_LAB_1]: [LAB_RESULT_1] - Reference range: [LAB_REFERENCE_1] - Significance: [LAB_SIGNIFICANCE_1]
...
- Patient factors affecting procedure: [PROCEDURE_PATIENT_FACTORS]
...
- Pathology reports: [PATHOLOGY_INCLUDED]
...
- Copy of report to: [REPORT_COPIES_TO]

Follow-up Plans:
- Post-consultation follow-up: [POST_CONSULT_FOLLOWUP_PLAN]
- Continuing care coordination: [CONTINUING_COORDINATION_PLAN]
...
- Best times to reach: [BEST_CONTACT_TIMES]

Thank you for your expertise in caring for [PATIENT_NAME]. Please contact me with any questions or if additional information is needed.

Sincerely,
[REFERRING_PROVIDER_SIGNATURE]
[REFERRING_PROVIDER_NAME], [REFERRING_PROVIDER_CREDENTIALS]
[REFERRING_PROVIDER_TITLE]
[REFERRING_INSTITUTION]
Date: [REFERRAL_COMPLETION_DATE]
...
✓ Specific questions articulated: [QUESTIONS_CLEAR]
✓ Urgency level appropriate: [URGENCY_APPROPRIATE]
✓ Records attached/available: [RECORDS_AVAILABLE]
✓ Contact information provided: [CONTACT_INFO_COMPLETE]

Referral quality: [REFERRAL_QUALITY_RATING]
```
...
PATIENT_CASE: "65-year-old with new onset chest pain and abnormal EKG"
SPECIALIST_RECIPIENT: "Interventional cardiologist"
REFERRAL_REASON: "Rule out acute coronary syndrome"
URGENCY_LEVEL: "Urgent - within 24 hours"
CONSULTATION_PURPOSE: "Risk stratification and treatment recommendations"
```

### Example 2: Dermatology Referral
```
REFERRAL_TYPE: "Routine dermatology consultation"
PATIENT_CASE: "Patient with changing mole and family history of melanoma"
SPECIALIST_RECIPIENT: "Dermatologist"
REFERRAL_REASON: "Evaluation of suspicious skin lesion"
URGENCY_LEVEL: "Routine - within 2 weeks"
CONSULTATION_PURPOSE: "Biopsy consideration and skin cancer screening"
```

### Example 3: Endocrinology Consultation
```
REFERRAL_TYPE: "Complex diabetes management consultation"
PATIENT_CASE: "Poorly controlled Type 1 diabetes with complications"
SPECIALIST_RECIPIENT: "Endocrinologist"
REFERRAL_REASON: "Optimize glycemic control and manage complications"
URGENCY_LEVEL: "Semi-urgent - within 1 week"
CONSULTATION_PURPOSE: "Advanced diabetes management and technology integration"
```
...
1. Start with this template (Referrals and Consultations Template)
...
Browse all **[clinical-healthcare/Clinical Practice](../../clinical-healthcare/Clinical Practice/)** templates for related tools and frameworks.

### Common Use Case Combinations

- **Creating comprehensive referral letters, consultation summaries, and specialist communication to ensure effective care coordination and optimal patient outcomes.**: Combine this template with related analytics and strategy frameworks
...
3. **Urgency Levels**
   ...
   - Elective (flexible timing)
   - Preventive (screening/wellness)

4. **Consultation Purposes**
